...
export default class More extends Component {
    ...
    render() {
        ...
        return (
            ...
            >
                <Header isRTL={isRTL} title="More" subTitle="Profile 8 Screens and More" />
                <FlatList
                    ...
                    renderItem={({ item, index }) => (
                        <TouchableOpacity
                            style={!isRTL ? styles.item : styles.itemRTL}
                            onPress={() => navigation.navigate(item.screen)}
                        >
                            <View style={!isRTL ? { flexDirection: "row" } : { flexDirection: "row-reverse" }}>
                                <Icon
                                    name={item.icon}
                                    color={BaseColor.primaryColor}
                                    size={18}
                                    solid
                                    style={!isRTL ? {transform: [{scaleX: 1}], marginRight: 10 } : {transform: [{scaleX: -1}], marginLeft: 10 }}
                                />
